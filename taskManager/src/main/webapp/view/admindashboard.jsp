    ...
    <div id="left-menu">
        <ul>
           <security:authentication property = "principal.authorities"></security:authentication>
            ...
            <li>
            <form:form action = "${pageContext.request.contextPath}/logout" method  = "post" style = "padding : 0px">
				<button type = "submit" style = "background : red; height : 100%; width : 100%">logout</button>
			</form:form>
            </li>
        </ul>
    </div>
